...
namespace PersonService
{
    ...
    static partial void ConfigureEndpoint(System.ServiceModel.Description.ServiceEndpoint serviceEndpoint, System.ServiceModel.Description.ClientCredentials clientCredentials);
        ...
        {
            this.Endpoint.Name = EndpointConfiguration.CustomBinding_IPersonService.ToString();
        ...
        {
            if ((endpointConfiguration == EndpointConfiguration.CustomBinding_IPersonService))
            {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.CustomBinding_IPersonService))
            {
                return new System.ServiceModel.EndpointAddress(new System.Uri("https://personregister-web.test.nhn.no/Personregister.WCF/PersonService.svc"), new System.ServiceModel.DnsEndpointIdentity("personregister-web.test.nhn.no"));
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
        ...
        {
            return PersonServiceClient.GetBindingForEndpoint(EndpointConfiguration.CustomBinding_IPersonService);
        }
        
        private static System.ServiceModel.EndpointAddress GetDefaultEndpointAddress()
        {
            return PersonServiceClient.GetEndpointAddress(EndpointConfiguration.CustomBinding_IPersonService);
        }
        
        public enum EndpointConfiguration
        {
            
            CustomBinding_IPersonService,
        }
    }
}
